import{S as F,i as I,s as J,a as U,k as c,q as m,P,h as t,c as g,l,m as r,r as f,n as x,b as C,G as e,H as K}from"../chunks/index.8a750992.js";function T(R){let d,n,u,_,w,b,j,a,h,E,k,v,q,z,y,H,S,p,D;return{c(){d=U(),n=c("div"),u=c("h1"),_=m("Examples of what can be used as input data"),w=U(),b=c("br"),j=U(),a=c("div"),h=c("h3"),E=m("Basic example"),k=U(),v=c("code"),q=m(`hostname: Valve Matchmaking Server (Hong Kong srcds1234-hkg56 #7)
...
#   1144 "player19"          [U:1:123456789]     01:10     68   0    active`),z=U(),y=c("h3"),H=m("Uglier but still functional"),S=U(),p=c("code"),D=m(`hostname: Valve Matchmaking Server (Hong Kong srcds1234-hkg56 #7)
version : 6986594/24 6986594 secure
...
#   2643 "7y98vf"           [U:1:234567891]     08:43      114    0 active`),this.h()},l(s){P("svelte-d71dee",document.head).forEach(t),d=g(s),n=l(s,"DIV",{class:!0});var o=r(n);u=l(o,"H1",{});var V=r(u);_=f(V,"Examples of what can be used as input data"),V.forEach(t),w=g(o),b=l(o,"BR",{}),j=g(o),a=l(o,"DIV",{class:!0});var i=r(a);h=l(i,"H3",{});var M=r(h);E=f(M,"Basic example"),M.forEach(t),k=g(i),v=l(i,"CODE",{class:!0});var N=r(v);q=f(N,`hostname: Valve Matchmaking Server (Hong Kong srcds1234-hkg56 #7)
version : 6986594/24 6986594 secure
udp/ip  : 169.254.123.234:61736
steamid : [A:1:1234567901:23456] (78901234567890123)
account : not logged in  (No account specified)
...
#   1136 "player17"          [U:1:123456789]     02:01     69   0    active
#   1138 "player18"          [U:1:234567891]     01:56     1038 58   active
#   1144 "player19"          [U:1:123456789]     01:10     68   0    active`),N.forEach(t),z=g(i),y=l(i,"H3",{});var O=r(y);H=f(O,"Uglier but still functional"),O.forEach(t),S=g(i),p=l(i,"CODE",{class:!0});var B=r(p);D=f(B,`hostname: Valve Matchmaking Server (Hong Kong srcds1234-hkg56 #7)
version : 6986594/24 6986594 secure
udp/ip  : 169.254.200.190:53328
steamid : [A:1:1446477828:19552] (90155969194459140)
#   2635 "abcde12345"        [U:1:123456789]    12:39      116    0 active
...
#   2642 "t09uw4"              [U:1:234567891]    09:10       57    0 active
#   2586 "3f89hr"           [U:1:123456789]    25:21       87    0 active
#   2643 "7y98vf"           [U:1:234567891]     08:43      114    0 active`),B.forEach(t),i.forEach(t),o.forEach(t),this.h()},h(){document.title="tf2cssplg2 | Examples",x(v,"class","svelte-ujemjy"),x(p,"class","svelte-ujemjy"),x(a,"class","svelte-ujemjy"),x(n,"class","container mt-6 svelte-ujemjy")},m(s,A){C(s,d,A),C(s,n,A),e(n,u),e(u,_),e(n,w),e(n,b),e(n,j),e(n,a),e(a,h),e(h,E),e(a,k),e(a,v),e(v,q),e(a,z),e(a,y),e(y,H),e(a,S),e(a,p),e(p,D)},p:K,i:K,o:K,d(s){s&&t(d),s&&t(n)}}}class Y extends F{constructor(d){super(),I(this,d,null,T,J,{})}}export{Y as default};
